...
- 电信服务商自带光猫。已申请公网。（不是专线？怎么申请的），请看下会分解。

- 红米路由器

- 海康录像机一台，很老的款。找教程的时候明显因为老款的原因，录像机的配置好多不一致。
...
- [x] 公网动态ip问题。解决方案有很多，我采用了上图描述的方案。
      
        已解决在 01-动态IP、阿里云服务器、代理、docker部署.md 中详细介绍
...
我是web前端，对网管（网线、设备、交换机），和运维（部署、服务器维护），服务端的专业知识是一知半解的。只有“学浅易懂”的水平。很多错误的地方请指正。
